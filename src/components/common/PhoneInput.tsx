  ...
  return (
    <div ref={ref} className="relative flex items-stretch">
      ...
      <div className="relative flex-1">
        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-medium text-sm pointer-events-none select-none">
          {selected.code}
        </span>
        <input
          ref={inputRef}
          ...
          className={clsx(
            ...
            "transition-all outline-none text-lg font-medium",
          )}
        />
      </div>
