        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="lg:w-2/3">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-xl border border-white/50 p-6 md:p-8 mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-[#1A2B48] text-sm">{t("perNight")}</div>
                </div>
              </div>
              ...
              {amenities.length > 0 && (
                <div className="border-t pt-6 mt-6">
                  <h2 className="text-xl font-semibold text-[#5000FF] mb-4">{t("amenities")}</h2>
            ...
            {hotel.rooms.length > 0 && (
              <div className="bg-white rounded-[2.5rem] shadow-xl border border-white/50 p-6 md:p-8 mb-6">
                <h2 className="text-xl font-semibold text-[#5000FF] mb-4">{t("rooms")}</h2>
                <div className="space-y-4">
                    ...
                    <div
                      key={room.id}
                      className="border border-gray-100 rounded-2xl p-4 md:p-6 hover:shadow-md transition-shadow"
                    >
                      <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                        <div className="flex-1">
                          ...
                          <p className="text-[#1A2B48] text-sm mb-2">
                          ...
                          {room.facilities && room.facilities.length > 0 && (
                            <div className="flex flex-wrap gap-2 mb-3">
                              {room.facilities.map((f: { id: number; name: string; icon: string | null }) => (
                                <span key={f.id} className="text-xs text-[#1A2B48] bg-gray-50 px-2 py-1 rounded border border-gray-100 flex items-center gap-1">
                          ...
                          {room.description && (
                            <p className="text-[#1A2B48] mt-2 text-sm">{room.description}</p>
                          )}
                        </div>
                        <div className="text-right ml-4">
                          ...
                          {room.salePrice && (
                            <div className="text-[#1A2B48] line-through text-sm">
                              {room.price} ₽
                            </div>
                          )}
                          <div className="text-[#1A2B48] text-sm">{t("perNight")}</div>
