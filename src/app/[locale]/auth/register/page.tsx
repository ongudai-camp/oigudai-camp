  ...
  const handleSendSMS = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || "Ошибка отправки СМС");
      }
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-4 bg-white text-gray-900 font-bold uppercase tracking-widest">{t("auth.orSignInWith")}</span>
            </div>
          </div>
          ...
          <div className="flex p-1 bg-gray-100 rounded-xl">
            <button
              onClick={() => { setRegisterMethod("phone"); setStep(1); setError(""); }}
            ...
            <button
              onClick={() => { setRegisterMethod("email"); setStep(1); setError(""); }}
              className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all duration-300 cursor-pointer ${
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-2xl text-sm font-bold animate-shake mt-4">
              {error}
            </div>
          )}
          ...
          {registerMethod === "phone" ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                      ...
                      <label htmlFor="privacy" className="text-sm text-gray-900 leading-tight">
                        ...
                        <span className="text-gray-900">({t("common.required")})</span>
                      </label>
                    </div>
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="flex gap-4">
                    <button
                      type="button"
                      onClick={() => setStep(1)}
                      className="px-6 py-4 border border-gray-200 text-gray-900 rounded-2xl font-bold hover:bg-gray-50 transition-all cursor-pointer"
                    >
                      ←
                    </button>
                    <button
            ...
            <form className="space-y-6 animate-in fade-in duration-500" onSubmit={handleEmailRegister}>
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <div className="flex items-center h-5">
                  <input
                    type="checkbox"
                ...
                <label htmlFor="privacy-email" className="text-sm text-gray-900 leading-tight">
                  {t("privacy.accept")}{" "}
                  <Link href={`/${locale}/privacy-policy`} className="text-sky-600 font-medium hover:underline">
                    {t("privacy.link")}
                  </Link>{" "}
              ...
              <div>
                <label htmlFor="email-reg-email" className="block text-sm font-bold text-gray-700 mb-2">
                  {t("auth.email")} *
                </label>
                <input
                  id="email-reg-email"
              ...
              <div>
                <label htmlFor="email-reg-name" className="block text-sm font-bold text-gray-700 mb-2">
                  {t("auth.name")} *
                </label>
                <input
                  id="email-reg-name"
              ...
              <div>
                <label htmlFor="email-reg-password" className="block text-sm font-bold text-gray-700 mb-2">
                  {t("auth.password")} *
                </label>
                <input
              ...
              <div>
                <label htmlFor="email-reg-confirm" className="block text-sm font-bold text-gray-700 mb-2">
                  {t("auth.confirmPassword")} *
                </label>
                <input
                  id="email-reg-confirm"
                  type="password"
                  required
                  value={formData.confirmPassword}
                  onChange={(e) => setFormData({ ...formData, confirmPassword: e.target.value })}
