      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            {items.length > 0 && (
              <p className="text-sm text-gray-500 mt-1">{items.length} {t("wishlistCount")}</p>
            )}
          </div>
          <Link
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">{t("wishlistEmptyHint")}</p>
              ...
              .map((item) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all shrink-0 cursor-pointer"
